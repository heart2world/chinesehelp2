...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('Wclass/index');?>">微课管理</a></li>
		</ul>
        <form class="well form-search" method="post" action="<?php echo U('Wclass/index');?>">
            微课标题:
            <input type="text" name="title" style="width: 100px;" value="<?php echo I('request.title/s','');?>" placeholder="请输入微课标题">&nbsp;
            发布教师：
            ...
            <a class="btn btn-danger" href="<?php echo U('Wclass/index');?>">清空</a>
        </form>
			...
			<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>				
					...
					<td style="text-align: center;">
							<a style="padding: 2px 15px;color: black;background-color: #bfc6cb;" class="btn btn-primary" href="<?php echo U('Wclass/detail',array('id'=>$vo['id']));?>">查看详情</a>		
							<a class="btn js-ajax-delete"  style="padding: 2px 15px;color: black;" href="<?php echo U('Wclass/delete',array('id'=>$vo['id']));?>"><?php echo L('DELETE');?></a>	
	...
	{
		$.ajax({
                url:"<?php echo U('Wclass/changesort');?>",
                data:{id:id,val:val},
                type:"POST",
                dataType:"json",
