...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo U('zhuanti/index');?>">专题管理</a></li>
		</ul>
        <form class="well form-search" method="post" action="<?php echo U('zhuanti/index');?>">
            标题:
            ...
            <a class="btn btn-danger" href="<?php echo U('zhuanti/index');?>">清空</a>
        </form>
		<table class="table table-hover table-bordered">
			...
			<thead>
				<tr>
					...
					<th style="text-align: center;min-width: 80px;">专题标题</th>
					...
					<th style="text-align: center;min-width: 80px;">教师端链接</th>	
					<th style="text-align: center;min-width: 80px;">学生端链接</th>	
			...
			<tbody>
				<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>				
					...
					<td style="text-align: center;"><?php echo ($vo["desc"]); ?></td>	
					<td style="text-align: center;"><?php echo ($vo["username"]); ?></td>					
					<td style="text-align: center;"><?php echo ($vo["clicknum"]); ?></td>					
					<td style="text-align: center;"><?php echo ($vo["createtime"]); ?></td>
					<td style="text-align: center;"><?php echo ($vo["compoint"]); ?></td>					
					<td style="text-align: center;"><input type="text" style="width: 35px;height: 10px;" onblur="changeindex(this.value,<?php echo ($vo["id"]); ?>)" value="<?php echo ($vo["sortorder"]); ?>"></td>
					<td style="text-align: center;"><?php echo ($vo["turl"]); ?></td>
					<td style="text-align: center;"><?php echo ($vo["surl"]); ?></td>
					<td style="text-align: center;">
						<a style="padding: 2px 15px;color: black;background-color: #bfc6cb;" class="btn btn-primary" href="<?php echo U('zhuanti/detail',array('id'=>$vo['id']));?>">查看详情</a>		
						<a class="btn js-ajax-delete"  style="padding: 2px 15px;color: black;" href="<?php echo U('zhuanti/delete',array('id'=>$vo['id']));?>"><?php echo L('DELETE');?></a>	
					</td>
	...
	{
		$.ajax({
			url:"<?php echo U('zhuanti/changesort');?>",
			data:{id:id,val:val},
			type:"POST",
			dataType:"json",
