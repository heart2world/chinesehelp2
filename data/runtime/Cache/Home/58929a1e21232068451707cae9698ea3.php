...
<section class="notice-content">
		<ul class="notice-list">
			...
			<!--<li class="notice-item">
				<a href="<?php echo ($va["link_url"]); ?>" title="<?php echo ($va["post_title"]); ?>">
					<div class="nt-top app-flex app-vertical-center">
						<h4 class="app-basis"><?php echo ($va["post_title"]); ?></h4>
						<h5><?php echo ($va["addtime"]); ?></h5>
					</div>
					<p><?php echo ($va["post_excerpt"]); ?></p>
				</a>
