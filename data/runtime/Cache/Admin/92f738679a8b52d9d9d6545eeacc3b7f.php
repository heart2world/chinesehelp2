...
<meta charset="utf-8">
<title>好问达 <?php echo L('ADMIN_CENTER');?></title>
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<a href="<?php echo U('admin/index/index');?>" class="brand"> <small> 
					好问达<?php echo L('ADMIN_CENTER');?>
				</small>
				</a>
				<div class="pull-left nav_shortcuts" >	

					<?php if(sp_auth_check(sp_get_current_admin_id(),'admin/setting/clearcache')): ?><a class="btn btn-small btn-danger" href="javascript:openapp('<?php echo U('admin/setting/clearcache');?>','index_clearcache','清空缓存');" title="<?php echo L('ADMIN_SETTING_CLEARCACHE');?>">
