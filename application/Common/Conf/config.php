...
$configs= array(
        ...
        'CRON_CONFIG' => array( 
            '测试执行定时任务' => array('Home/Index/crons', '10', ''), //路径(格式同R)、间隔秒（0为一直运行）、指定一个开始时间 
        ),
        /* 标签库 */
        'TAGLIB_BUILD_IN' => THINKCMF_CORE_TAGLIBS,
        'MODULE_ALLOW_LIST'  => array('Admin','Home','Portal'),
        ...
        'UPLOAD_SITEIMG_QINIU' => array ( 
                ...
                'driver' => 'Qiniu',
                'driverConfig' => array (
                        'accessKey' => 'vCrvqfZvSjHyQDjjV2rYTRRJrdwuR2uUS-bHz-DW',
                        'secrectKey' => 'T3NBn0PhWdcpBs2NB1nyJMEp9nzKFf5pm6npKoyj', 
                        'domain' => 'qiniukoper.heart2world.com',
                        'bucket' => 'xly2018', 
            )
        )
);
